...
<body>
<!-- start: HEADER -->
<div class="navbar navbar-inverse navbar-fixed-top" style="background-color: #141a6b;">
...
<div class="navbar-header">
    ...
    <a class="navbar-brand" href="index.html" style="color: #ffffff;">
        <i class="fa fa-bar-chart-o" style="color: #ffffff;"></i> RecruitFox SRM</a>
    </a>
    <!-- end: LOGO -->
</div>
...
<li class="dropdown current-user">
    <a data-toggle="dropdown" data-hover="dropdown" class="dropdown-toggle" data-close-others="true" href="#">
        ...
        <span class="username">Avi Gopinath</span>
...
<li class="active open">
    <a href="#"><i class="clip-screen"></i>
        <span class="title"> Workspace </span><span class="selected"></span>
    </a>
</li>
<li>
    <a href="javascript:void(0)"><i class="fa fa-file-text"></i>
        <span class="title"> Jobs </span><i class="icon-arrow"></i>
        <span class="selected"></span>
    </a>
    <ul class="sub-menu">
        <li>
            <a href="#">
                <span class="title"> My Open Jobs </span>

            </a>
        </li>
        <li>
            <a href="#">
                <span class="title"> My Closed Jobs </span>
            </a>
        </li>
        <li>
            <a href="#">
                <span class="title"> Jobs on Hold </span>
            </a>
        </li>
        <li>
            <a href="#">
...
<li>
    <a href="javascript:void(0)"><i class="clip-users"></i>
        <span class="title"> Candidates </span><i class="icon-arrow"></i>
        <span class="selected"></span>
    </a>
    <ul class="sub-menu">
        <li>
            <a href="candidates.html">
                <span class="title"> My Candidates </span>
            </a>
        </li>
        <li>
            <a href="#">
        ...
        <li>
            <a href="#">
                <span class="title"> Future Profiles </span>
            </a>
        </li>
        <li>
            <a href="#">
                <span class="title"> VIP Profiles </span>
            </a>
        </li>
        <li>
            <a href="#">
                <span class="title"> Readily Available </span>
            </a>
        </li>
        <li>
            <a href="#">
                <span class="title"> Location 1 </span>
            </a>
        </li>
        <li>
            <a href="#">
                <span class="title"> Location 2 </span>
            </a>
        </li>
        <li>
            <a href="#">
                <span class="title"> Location 3 </span>
            </a>
        </li>
        <li>
            <a href="#">
                <span class="title"> Skill 1 </span>
            </a>
        </li>
        <li>
            <a href="#">
                <span class="title"> Skill 2 </span>
            </a>
        </li>
    </ul>
</li>
...
<li>
    <a href="javascript:void(0)"><i class="fa fa-building-o"></i>
        <span class="title"> Clients and Contacts</span><i class="icon-arrow"></i>
        <span class="selected"></span>
    </a>
    <ul class="sub-menu">
        <li>
...
<li>
    <a href="javascript:void(0)"><i class="fa fa-tasks"></i>
        <span class="title">My Tasks</span><i class="icon-arrow"></i>
        <span class="selected"></span>
    </a>
    <ul class="sub-menu">
        <li>
...
<li>
    <a href="javascript:void(0)"><i class="fa fa-usd"></i>
...
<li>
    <a href="javascript:void(0)"><i class="clip-tree"></i>
        <span class="title">Time Lines</span><i class="icon-arrow"></i>
        <span class="selected"></span>
    </a>
    <ul class="sub-menu">
        <li>
...
<li>
    <a href="charts.html"><i class="clip-eye"></i>
        <span class="title">Analytics and Insights</span>
        <span class="selected"></span>
    </a>
</li>
...
<li>
    <a href="maps.html"><i class="clip-location"></i>
        <span class="title">Geographic Distribution</span>
        <span class="selected"></span>
    </a>
</li>
...
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="page-header">
            <h1>My Workspace <small>overview &amp; stats </small></h1>
        </div>
